        ...
        <Card className={classes.card} raised elevation={6}>
            <ButtonBase className={classes.cardAction} onClick={openPost}>
                ...
                <div className={classes.overlay}>
                    ...
                    <Typography variant="body2">{moment(new Date(post.createdAt.toLocaleString())).fromNow()}</Typography>
                </div>
                ...
                <Typography className={classes.title} style={{ margin: 0 }} variant="h5" component="h2">{post.title}</Typography>
                <CardContent style={{ height: "100px", textOverflow: 'ellipsis', overflow: "hidden", padding: "5px 20px" }}>
